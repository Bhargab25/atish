          ...
          <div class="box box-solid box-default">
            <div class="box-header">
              ...
              <h3 class="box-title">Asset List</h3>
                ...
                <a href="javascript:void" class="fa fa-th-list" id="listview_icn"></a> | <a href="javascript:void" class="fa fa-th-large" id="tileview_icn"></a>
                </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body no-padding" id="lockers_view">
