...
public static function Create(NOTIFICATION_MODEL $model) {
        $mysqli = Config::OpenDBConnection();
        $query = "INSERT INTO `Notification`(`ID`, `BID`, `TYPE`,`ALERT_COUNT`, `SENT`,`CREATEDATE`) values(NULL,'$model->BID','$model->TYPE','$model->ALERT_COUNT',$model->SENT,'$model->CREATEDATE')";
